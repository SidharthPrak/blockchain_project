...
contract ERC20Token is ERC20Interface {
    ...
    string public symbol; // Short identifier for the token (i.e., FDT)
    ...
    constructor(
        ...
        totSupply = _initialAmount; // Update the total token supply
    ...
    // Set the allowance for a specified address
    function approve(
        address _spender,
        uint256 _value
    ) public override returns (bool success) {
    ...
    // Return the allowance for a specific owner and spender
    function allowance(
        address _owner,
        address _spender
